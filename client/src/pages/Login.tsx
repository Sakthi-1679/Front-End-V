        ...
        <div>
          ...
          <div className="relative">
            <input 
              ...
              required 
              className="w-full bg-gray-50 border-2 border-gray-100 rounded-2xl p-4 pr-12 font-bold focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition-all" 
              placeholder="••••••••"
              value={password} 
